...
/**
 * Resolves and authorizes the request principal stashed by the JWT filter. Centralizes the
 * "no principal -> 401" and "wrong role -> 403" checks so controllers stay declarative. This is the
 * defense-in-depth complement to the security chain's {@code /ops/** → hasAnyRole(OPS, APPROVER)} rule.
 */
@Component
