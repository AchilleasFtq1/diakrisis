...
/**
 * The bank-app Spring Security filter chain. Stateless (no sessions, no CSRF — this is a JSON API),
 ...
 *   <li>everything else requires authentication; the fine-grained CUSTOMER/OPS/APPROVER + account-
 *       binding checks stay in the controllers ({@code CurrentUser}), which read the principal the
 *       filter also stashes as a request attribute.</li>
 * </ul>
 *
