 ...
 * 401/403, and missing resources 404. Downstream decision-service status codes are passed through.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleDownstream(HttpStatusCodeException ex) {
        // Propagate decision-service's status + body verbatim so callers see the real decision error.
